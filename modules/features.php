                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>Staqpesa is accessible from all devices. Supports exporting and importing 
                            ...
                            interface, we guarantee you smooth transition to harnessing the power of Staqpesa. </p>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>No infrastructural setup. Subscribe to any 
                            ...
                            Enjoy all Staqpesa features with guaranteed excellent support 
                            and updates at no extra costs.</p>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>Staqpesa is easily customizable to suit your needs, 
                            ...
                            Staqpesa guarantees accomodation of present and future needs and changes. 
                            All solution elements are easily configurable.</p>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>Staqpesa allows SACCOs & MFIs to know their authenticated clients by 
                            ...
                            Clients can be analyzed in multidimensional attributes. 
                            This facilitates targeted campaigning/communication.</p>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>Staqpesa supports multiple loan products (both reducing balance 
                            ...
                            as their defined parameters. It supports in depth credit 
                            scoring and loan appraisal through guarantor management 
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>System usage is based on secure authentication of users. 
                            ...
                            based on their roles. Their actions on the system are also trailed 
                            and logged (by date, time and module access point) for audit purposes. 
                            Crucial system activities are also managed/monitored 
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="#" class="home-services-item">
                        ...
                        <p>Staqpesa has onboard tools to complement organizational marketing efforts. 
                            ...
                            It is also integrated with social media platforms and can interlinked with 
